    ...
    def forward(
        ...
        args = (
            ...
            raster_settings.debug,
             sh_scales if sh_scales is not None else torch.empty(0, device=means3D.device),
             max_depth  # 新
        )
...
class GaussianRasterizer(nn.Module):
    ...
    def forward(self, means3D, means2D, opacities, scores, shs = None, colors_precomp = None, scales = None, rotations = None, cov3D_precomp = None, sh_scales=None, max_depth=None):
